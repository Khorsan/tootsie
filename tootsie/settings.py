"""
Django settings for tootsie project.
...
SECRET_KEY = '8a9vrv9pz_p6a9(dr$rdiv&9d%kmewx-poxssjz#qg*4kuqii8'
...
WSGI_APPLICATION = 'tootsie.wsgi.application'
