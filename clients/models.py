...
class Client(models.Model):
    ...
    gender = models.CharField(choices=GENDER_CHOICES,
                              max_length=254, blank=True, default=GENDER_CHOICES[1])
    ...
    divida = models.IntegerField(blank=True, default=0)
...
class Profile(models.Model):
    ...
    instructor = models.BooleanField(blank=False)
...
class Session(models.Model):
    ...
    driver = models.ForeignKey(
        Driver, null=False, on_delete=models.CASCADE)
    instructor = models.ForeignKey(
        Instructor, null=False, on_delete=models.CASCADE)
    Boat = models.ForeignKey(
        Boat, null=False, on_delete=models.CASCADE, default="")
    price = models.FloatField(blank=True, null=True)
    ...
    def get_absolute_url(self):
        return reverse('sessions-details')
